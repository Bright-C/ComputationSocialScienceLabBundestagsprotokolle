...
class TestParseReactions(unittest.TestCase):
    ...
    def test_as_reaction_and_performer_5(self):
        ...
        self.assertEqual(parsed_reaction, "UNSPECIFIED_LINKE")
